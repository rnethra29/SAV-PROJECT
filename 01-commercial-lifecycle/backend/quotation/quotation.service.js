...
const quotationItemRepository = require('./quotationItem.repository');
...
const { QUOTATION_TRANSITIONS, isValidTransition } = require('../../../shared/backend/models/statusTransitions');
