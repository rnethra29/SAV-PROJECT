...
const authenticate = require('../../../backend/middlewares/auth.middleware');
const requireRole = require('../../../backend/middlewares/role.middleware');
const validate = require('../../../backend/middlewares/validation.middleware');
const { idParam } = require('../../../backend/validators/common.validator');
...
const { ROLES } = require('../../../backend/models/enums');
