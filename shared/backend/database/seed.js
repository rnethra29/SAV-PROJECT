...
const { ITEM_CATEGORIES, PRICE_SOURCE_TYPES, DOCUMENT_CATEGORIES } = require('../../../01-commercial-lifecycle/backend/database/seeds/001_lookup_data');
const { CLIENT_TYPES, INDUSTRIES, CONTACT_TYPES } = require('../../../02-site/01-client-management/backend/database/seeds/002_client_management_lookup_data');
const { VENDOR_TYPES, MATERIAL_CATEGORIES } = require('../../../02-site/02-vendor-management/backend/database/seeds/003_vendor_procurement_lookup_data');
const { ROLES: RBAC_ROLES, PERMISSIONS, ROLE_PERMISSIONS } = require('../../rbac/backend/database/seeds/004_rbac_seed_data');
