...
const { clientTypeService, industryService, contactTypeService } = require('../services/clmLookup.service');

function makeClmLookupController(service) {
  return {
...
module.exports = {
  clientTypeController: makeClmLookupController(clientTypeService),
  industryController: makeClmLookupController(industryService),
  contactTypeController: makeClmLookupController(contactTypeService),
};
