...
const clmClientRepository = require('../../../01-client-management/backend/repositories/clmClient.repository');
...
const { CLM_PROJECT_TRANSITIONS, isValidTransition } = require('../../../../shared/backend/models/statusTransitions');
