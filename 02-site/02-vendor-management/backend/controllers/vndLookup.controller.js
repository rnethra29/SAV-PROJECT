...
const { vendorTypeService, materialCategoryService } = require('../services/vndLookup.service');

function makeVndLookupController(service) {
  return {
...
module.exports = {
  vendorTypeController: makeVndLookupController(vendorTypeService),
  materialCategoryController: makeVndLookupController(materialCategoryService),
};
